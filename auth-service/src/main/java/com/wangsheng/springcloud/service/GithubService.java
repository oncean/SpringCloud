...
import com.wangsheng.springcloud.common.model.github.GithubToken;
...
public class GithubService {
    ...
    @Value("${github.client_id:a00caa2d5e8032f8ad12}")
    private String client_id;

    @Value("${github.client_secret:bf0fb256bd312f38b52c5043c565f8a799fcf485}")
